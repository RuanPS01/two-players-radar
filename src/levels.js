...
export const LEVELS = {
  ...
  2: { name: 'Lento', short: 'Apitos lentos', desc: 'Apitos espacados. Alvo distante.', interval: 1000, kind: 'beep' },
  3: { name: 'Medio', short: 'Apitos medios', desc: 'Apitos sequenciais moderados.', interval: 550, kind: 'beep' },
  4: { name: 'Rapido', short: 'Apitos rapidos', desc: 'Apitos rapidos. Alvo se aproximando.', interval: 260, kind: 'beep' },
  5: { name: 'Continuo', short: 'Apito continuo', desc: 'Apito continuo, sem pausa. Alvo colado.', interval: 0, kind: 'continuous' },
};
